...
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=0.95\textwidth]{images/{Schematic-diagram-of-a-24-tile-LOFAR-HBA-station-A-tile-is-made-of-16-dual-polarization.png}}
...
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=0.95\textwidth]{images/{hbaim.jpeg}}
	\caption{\label{fig.hba.im} Picture of an HBA tile. Source: Figure 1 of \citetads{2012A&A...545A.108N}}
\end{subfigure}
\caption{HBA tile layout and image. Note that both cases show a 24-tile HBA array: each core station includes two such arrays. International stations include a single larger tile array.}
\end{figure}
