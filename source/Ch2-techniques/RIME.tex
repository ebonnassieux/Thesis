...
\pg
For $\mathbf{e}$ to be a 2-vector, rather than a 3-vecotr, we must choose to use $xyz$ as our coordinates, with $z$ the direction of propagation of our signal. \citetads{1996A&AS..117..137H} then show that the following relation holds:
\begin{equation}
