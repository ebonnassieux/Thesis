...
\pg
For a mathematically rigorous description of the RIME, the references used in this work (particularly \citepads{2011A&A...527A.108S} and \citepads{2011A&A...531A.159S}) are obviously the first place to look. The author takes great care to frame the RIME in the continuity of previous theoretical frameworks of radio interferometry, while also describing it in the context of contemporary software packages and algorithmic tools.

\subsection{Setting up the RIME: a single point source}
...
\subsection{Expanding our Jones Chain}
...
\subsubsection{Geometric Effects: the Phase Delay Jones Matrix}
...
\subsubsection{The Coherency Matrix}
...
\subsection{Multiple Point Sources}
...
\subsection{Diffuse Emission: the Full-sky RIME}
\label{section.RIME.FullSky}

\subsubsection{Deriving the Fully-Sky RIME}
...
\subsubsection{Recovering the van Cittert-Zernike Theorem}
...
\subsection{Time-dependent Jones matrices, Smearing, and Decoherence}
\label{section.RIME.TimeDep}

\subsubsection{Time-dependence of Jones matrices}
...
\subsubsection{Smearing and Decoherence}
