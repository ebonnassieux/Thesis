...
\pg
The data was acquired through the LOFAR Long-Term Archive, and is thus pre-processed and flagged for RFI using the standard tools \citepads[NDPPP and AOFlagger; see][ respectively]{2018ascl.soft04003V,2010ascl.soft10017O}. The next step is therefore to calibrate the data.
